...
namespace EmpSalaryData
{
    ...
    public enum JobFamily { D0Mgm, D1Afs, D2Fir, D2Pol, D3Trd, D4Pt, D5Adm, D7Law, D8Smg, D9Leg };

    public enum Paygroup { Fir, Gen, Mgm, Pol };

    public enum Race { AmericanIndianAlaskanNative, AsianPacificIslander, Black, Chinese, Hispanic, Unknown, White };

    public enum SalAdminPlan { D0, D0C, D1, D3, D4, D4M, D5, D8, D9, F40, F48, Law, Pol };
    ...
    {
        public static string ToJson(this List<EmpSalary> self) => JsonConvert.SerializeObject(self, EmpSalaryData.Converter.Settings);
    }
